...
export const SearchedCountry = ({isDark}) => {
    ...
    <div className={`${darktheme} duration-700 transition-colors`}>
        ...
        className={`${darktheme2} ml-12 mt-12 rounded-lg shadow-md shadow-slate-400 px-6 py-2 font-semibold flex justify-between`}>
